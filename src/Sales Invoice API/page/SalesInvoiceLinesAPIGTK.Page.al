...
page 50101 "Sales Invoice Lines API GTK"
{
    DelayedInsert = true;
    APIGroup = 'GTKAPI';
    APIPublisher = 'GTKIPL';
    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                field(allowInvoiceDiscountGTK; Rec."Allow Invoice Discount GTK")
                {
                    Caption = 'Allow Invoice Discount GTK';
                    trigger OnValidate()
                    begin
                        RegisterFieldSet(Rec.FieldNo("Allow Invoice Discount GTK"));
                    end;
                }
                ...
                field(invDiscountAmount; Rec."Inv. Discount Amount")
                {
                    ...
                    trigger OnValidate()
                    begin
                        RegisterFieldSet(Rec.FieldNo("Inv. Discount Amount"));
                    end;
                }
